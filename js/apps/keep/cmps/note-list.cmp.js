    ...
    template: `
        <section class="notes main-layout">
            ...
            <section class="note-list un-pinned-notes" v-if="unPinnedNotes">
                ...
                <note-preview v-for="note in unPinnedNotes" :key="note.id" :note="note" @note-pinned="togglePin" @note-deleted="deleteNote" @note-bgc-updated="updateBgc" @todo-done="toggleTodo" @note-duplicate="duplicateNote" @editor-opened="openScreen" @note-edited="editNote" />
            </section>
        </section>
    `,
    components: {
